...
exports.orderPartTransformRule = exports.orderItemTransformRule = exports.orderDetailTranformRule = void 0;

var _util = require("../util");

var orderItemTransformRule = {
  item: {
    orderId: "orderId",
...
exports.orderItemTransformRule = orderItemTransformRule;
var orderPartTransformRule = {
  item: {
    orderId: "orderId",
    orderPartSeqId: "shipGroupSeqId",
    partName: "orderName",
    ...
    customer: {
      ...
      person: {
        ...
        // assigning customerPartyName to firstName and then using operate on this field to get the firstName
    ...
    contactMechs: [{
      ...
      orderPartSeqId: "shipGroupSeqId",
      contactMechId: "",
      // TODO: check for mech id as we are not receiving it in current resp
      contactMech: {
        contactMechId: "",
...
exports.orderPartTransformRule = orderPartTransformRule;
var orderDetailTranformRule = {
  item: {
    orderId: "orderId",
    orderName: "orderName",
  ...
  operate: [{
    run: function run(orderIdentifications) {
      // TODO: store the id (here SHOPIFY_ORD_ID) in a config file
      return (0, _util.getIdentification)(orderIdentifications, 'SHOPIFY_ORD_ID');
    },
    on: "externalId"
  }]
};
exports.orderDetailTranformRule = orderDetailTranformRule;